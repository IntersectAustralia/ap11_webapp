...
EOM
      service_hash = {
          :description => '	The Proteomic Genomic Nexus is a software tool that:&lt;/p&gt;&lt;p&gt;1. allows genomics and transcriptomics data from next-generation sequencing to be integrated with that from proteomics, and&lt;/p&gt;&lt;p&gt;2. allows the integrated data to assist in the confirmation of open reading frames and/or splice isoforms in a directed or naive way.&lt;/p&gt;',
