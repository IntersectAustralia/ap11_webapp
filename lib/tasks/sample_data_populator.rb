...
def create_test_users
  ...
  set_role("veronica@intersect.org.au", "admin")
  set_role("marc@intersect.org.au", "admin")
  set_role("diego@intersect.org.au", "admin")
  set_role("shuqian@intersect.org.au", "admin")
